...
def run_backtest(returns, prices=None, start_date='2011-01-01'):
    setup_directories()
    ...
    pi_hist, w_eq, delta_df = equilibrium.compute_equilibrium_returns(returns, window=252)
...
def main():
    ...
    # Change the execution date here
    run_backtest(returns, prices=prices, start_date='2011-01-01')
